...
export declare class SQSQueueProvider implements QueueProvider {
    private readonly queueUrlMap;
    private client;
    constructor(queueUrlMap: Record<string, string>, region: string);
...
//# sourceMappingURL=SQSQueueProvider.d.ts.map