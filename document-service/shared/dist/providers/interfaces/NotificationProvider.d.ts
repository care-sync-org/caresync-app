export type NotificationType = 'APPOINTMENT_CREATED' | 'APPOINTMENT_CONFIRMED' | 'APPOINTMENT_CANCELLED' | 'APPOINTMENT_COMPLETED' | 'DOCUMENT_UPLOADED' | 'RECORD_ADDED' | 'SYSTEM';
